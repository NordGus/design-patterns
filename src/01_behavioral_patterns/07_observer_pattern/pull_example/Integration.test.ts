...
describe("Notification mechanism to update multiple elements in an app", () => {
    ...
    it("should have notified all spreadsheets", () => {
        expect(spy).toHaveBeenNthCalledWith(1, "Spreadsheet has been notified with 42");
        expect(spy).toHaveBeenNthCalledWith(2, "Spreadsheet has been notified with 42");
    });
    
    it("should have notified the chart", () => {
        expect(spy).toHaveBeenNthCalledWith(3, "Chart has been notified with 42");
    });
});